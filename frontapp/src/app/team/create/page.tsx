...
export default function createTeam() {
  ...
  const [team,setTeam] = useState({teamName:"",teamDescription:"",teamImg:""})
  ...
  const doSubmmit = async (e) => {
    ...
    await api.post("/api/v1/team/create",formData)
    .then(
      res => {
        alert(res.data.msg);
          ...
          <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="mt-2">
                  <input type="text" name="teamName" onChange={handlerChange} required 
              ...
              <div>
                <div className="flex items-center justify-between">
                  <label htmlFor="teamDescription" className="block text-sm font-medium leading-6 text-gray-900">
                    Team description
                  </label>
                </div>
                <div className="mt-2">
                  <textarea name="teamDescription" onChange={handlerChange} required
                  className="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                </div>
              </div>
